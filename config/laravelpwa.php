...
return [
    'name' => 'Zenner Tasks',
    'manifest' => [
        'name'             => env('APP_NAME', 'Zenner Tasks'),
        'short_name'       => 'Zenner',
        'start_url'        => '/',
        ...
        'icons' => [
            ...
            '512x512-maskable' => ['path' => '/images/icons/icon-maskable-512x512.png', 'purpose' => 'maskable'],
        ],
        'splash' => [
        ...
        'shortcuts' => [
            [
                ...
                'url'         => '/dashboard',
                'icons'       => ['src' => '/images/icons/icon-96x96.png', 'purpose' => 'any'],
            ],
            [
                'name'        => 'Projects',
