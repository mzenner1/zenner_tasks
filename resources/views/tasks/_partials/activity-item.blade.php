<div class="flex items-start gap-3 text-sm">
    <div class="w-6 h-6 rounded-full bg-gray-200 flex items-center justify-center text-[10px] font-bold text-gray-500 flex-shrink-0 mt-0.5">
        {{ $entry->user ? strtoupper(substr($entry->user->name, 0, 1)) : 'S' }}
    </div>
